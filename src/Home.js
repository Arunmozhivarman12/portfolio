...
const Home = () => {
    return (
        <div >
            <Container fluid className='main pb-5'>
                <Container>
                    <Row className='text-light pb-5'>
                    ...
                    <Row className='mt-5 pt-5 mb-3'>
                        <h3 className='ms-3 text-light mt-3'>Proje<mark className='name ps-0'>cts</mark></h3>
                        <div className="certline mt-2 ms-4"></div>
                    </Row>

                    <Row className=' ms-1'>
                        <h4 className='mt-4 mb-3 text-light'>Ecommerce App<mark className=' fs-6 ms-2 bg-transparent text-secondary'>using React</mark></h4>
                        <Col lg={{ span: 8, order: 1 }} md={{ order: 2 }} sm={{ order: 2 }} xs={{ order: 2 }}>

                            <p className=' mt-3 fs-6 text-light project-description'>I developed an e-commerce application using the MERN (MongoDB, Express, React, Node.js) stack, showcasing my skills in full-stack web development.
                    ...
                    <Row className='ms-1 mt-5'>
                        <h4 className='mt-4 mb-3 text-light'>Music player App<mark className=' fs-6 ms-2 bg-transparent text-secondary'>using React</mark></h4>
                        <Col lg={{ span: 8, order: 1 }} md={{ order: 2 }} sm={{ order: 2 }} xs={{ order: 2 }}>

                            <p className=' mt-3 fs-6 text-light project-description'>
                    ...
                    <Row className='mt-5 mb-3'>
                        <h3 className='ms-3 text-light mt-3'> Mini Proje<mark className='name ps-0'>cts</mark></h3>
                        <div className="certline mt-2 ms-4"></div>
                    </Row>

                    <Row className='ms-1 '>
                        <h4 className='mt-2 mb-3 text-light'>Crud App<mark className=' fs-6 ms-2 bg-transparent text-secondary'>using React</mark></h4>
                        <p className=' mt-2 fs-6 text-light project-description'> I developed a mini project using the MERN (MongoDB, Express, React, Node.js) stack.
                    ...
                    <Row className='ms-1 '>
                        <h4 className='mt-5 mb-3 text-light'>Authentication <mark className=' fs-6 ms-2 bg-transparent text-secondary'>using React</mark></h4>
                        <p className=' mt-2 fs-6 text-light project-description'>This mini MERN (MongoDB, Express.js, React.js, Node.js) project is an authentication app that allows users to sign up and log in to securely view and manage their data.
                    ...
                    <Row className='ms-1 '>
                        <h4 className='mt-5 mb-3 text-light'>Form validation<mark className=' fs-6 ms-2 bg-transparent text-secondary'>using HTML</mark></h4>
                        <p className=' mt-2 fs-6 text-light project-description'> This web page utilizes HTML, CSS, and JavaScript to create a form validation functionality.
                    ...
                    <Row className='ms-1 '>
                        <h4 className='mt-5 mb-3 text-light'>Fetch ApI<mark className=' fs-6 ms-2 bg-transparent text-secondary'>using React</mark></h4>
                        <p className=' mt-2 fs-6 text-light project-description'> This mini project utilizes the Fetch API in combination with React to build a data retrieval application.
